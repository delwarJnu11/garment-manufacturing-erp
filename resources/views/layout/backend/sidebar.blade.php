                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul style="margin-left: 20px;">
                                <li>
                                    <x-link href="{{ route('production-plans.index') }}" :active="request()->is('production-plan*')">Production
                                        Plans</x-link>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul style="margin-left: 20px;">
                                <li>
                                    <x-link href="{{ route('production-work-orders.index') }}" :active="request()->is('production-work-orders*')">Work
                                        Order List</x-link>
                                </li>
                                <li>
                                    <x-link href="{{ route('production-work-status.index') }}" :active="request()->is('production-work-status*')">Work
                                        Status</x-link>
                                </li>
                                <li>
