                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);">
                                ...
                                <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ url('/roles') }}">Products list</a></li>
                                <li>
                                    <a href="{{ url('/roles') }}">Units</a></li>
                                <li>
                                    <a href="{{ url('/roles') }}">Variation</a></li>
                                <li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);">
                                ...
                                <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ url('/roles') }}">Storage Location</a></li>
                                <li>
...
{{--                              
                            <ul class="nav flex-column ms-3">
                                ...
                                <li><a class="nav-link" href="#"> Storage Locations</a></li>
                            </ul>
                        </li> --}}
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a
                                        href="https://dreamspos.dreamstechnologies.com/html/template/icon-bootstrap.html">Bootstrap
                                        Icons</a>
                                </li>
                                <li>
