                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p><strong>Address: </strong><span class="buyer_address"></span></p>
                                <p><strong>Email: </strong><span class="buyer_email"></span></p>
                            </div>
                                    ...
                                    <select class="form-control" id="order_id" name="order_id">
                                        ...
                                        @foreach ($orders as $order)
                                            <option value="{{ $order->id }}">
                                                {{ $order->order_number }} - {{ $order->buyer->first_name }} {{ $order->buyer->last_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
