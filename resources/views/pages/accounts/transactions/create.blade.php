...
@section('page_content')
    ...
    <div class="container my-5">
        ...
        <form action="{{ route('accounts.transactions.store') }}" method="POST">
            @csrf
            <div class="row mb-3 d-flex justify-content-between">
                <!-- <label for="voucher_ref" class="col-sm-2 col-form-label">Voucher Ref</label> -->
                <div class="col-sm-4">
                    <input value="{{ $voucher_ref }}" type="text" class="form-control" name="voucher_ref" id="voucher_ref" placeholder="Voucher Ref">
                </div>
                ...
                <div class="col-sm-2">
                    <input type="date" class="form-control" name="transaction_date" id="transaction_date"
                        value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" placeholder="Transaction Date">
