...
<div class="container mt-5">
    ...
    <a href="{{ route('accounts.accountGroups.index') }}" class="btn btn-secondary mb-3">Back to List</a>

    <form action="{{ route('accounts.accountGroups.update', $accountGroup->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
