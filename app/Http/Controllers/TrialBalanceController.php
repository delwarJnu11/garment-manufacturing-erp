...
class TrialBalanceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.accounts.trial_balance.print', compact('trialBalance', 'start_date', 'end_date'));
    }
    ...
    public function printPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('pages.accounts.trial_balance.pdf', compact('trialBalance', 'start_date', 'end_date'));
