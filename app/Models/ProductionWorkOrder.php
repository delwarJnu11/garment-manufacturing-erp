...
class ProductionWorkOrder extends Model
{
    ...
    protected $fillable = ['production_plan_id', 'order_id', 'assigned_to', 'work_order_status_id', 'total_quantity', 'cutting_status', 'sewing_status', 'finishing_status', 'packaging_status', 'wastage'];
