...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function resetThemeAndLayoutSettings() {
        ...
        // Reset radio buttons
        const lightThemeRadio = document.querySelector(
            'input[name="themes"][value="light_mode"]'
        );
        const defaultLayoutRadio = document.querySelector(
            'input[name="layout"][value="default"]'
        );
        const lightColorRadio = document.querySelector(
            'input[name="nav_color"][value="light"]'
        );
    ...
    if (resetButton)
        resetButton.addEventListener("click", resetThemeAndLayoutSettings);
});
